...
<html lang="en">
	...
	<body>
		 ...
		 <h3 class="align-center">รายละเอียด ขออนุมัติ การโยกงบประมาณ</h3>
        ...
        <div class="example" data-text="รายการ">
            <table id="table_approveRockingBudget" class="cell-border hover display compact nowrap" cellspacing="0" width="100%">
                ...
                <tr>  
                    ...
                    <th>เงินก่อนโยก</th>
                    <th>เงินคงเหลือ</th>
                    <th>ค่าใช้จ่าย ที่ทำการโยกงบ</th>
                    <th>เงินคงเหลือ</th> 
        		...
        		%>
        			<tr>
	                    ...
	                    <td align="right"><%=Float.parseFloat(anInfo.getFrombalance().replace(",", ""))+Float.parseFloat(anInfo.getRocking_budget().replace(",", ""))%></td>
	                    <td align="left"><%=anInfo.getGcostname_rock()%></td>  
	                    <td align="right"><%=anInfo.getFrombalance_rock()%></td>  
